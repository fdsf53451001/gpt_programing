...
def main():
    ...
    title_html = f"<h1 align=\"center\">ChatGPT 編程优化 {get_current_version()}</h1>"
    ...
    cancel_handles = []
    with gr.Blocks(title="ChatGPT 編程优化", theme=set_theme, analytics_enabled=False, css=advanced_css) as demo:
        gr.HTML(title_html)
